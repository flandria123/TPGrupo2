...
namespace Users.API.Controllers
{
    ...
    [Tags("Users")] // Agrupación por tags requerida por el TP [2]
...

    {
        ...
        [HttpPost("register")]
        [ProducesResponseType(typeof(UserResponse), 201)] // Ayuda a Swagger a mostrar el esquema del DTO [1]
        ...
        /// <response code="403">Usuario bloqueado por intentos (USR-004) o seguridad (USR-005) [5].</response>
        [HttpPost("login")]
