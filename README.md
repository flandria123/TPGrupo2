...
## Descripción General
Este proyecto implementa un sistema de E-Commerce basado en una arquitectura de microservicios distribuidos. La solución expone 5 REST APIs independientes desarrolladas en C# con .NET, cumpliendo con los contratos de diseño, manejo de excepciones de dominio, y observabilidad exigidos por la cátedra.

## Arquitectura y Tecnologías
El proyecto fue construido siguiendo estrictas reglas de separación de responsabilidades y buenas prácticas:

* **Framework:** ASP.NET Core 8 (Arquitectura basada en Controllers).
